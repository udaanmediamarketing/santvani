...
export async function parseOrganizationFormData(req, res, userId) {
        ...
        form.parse(req, async (err, fields, files) => {
            ...
            if (imageFile) {
                try {
                    ...
                    imageUrl = await uploadToCloudStorage(buffer, imageFile.originalFilename || "organization.jpg", userId);
                    // cleanup temp file
...
//# sourceMappingURL=orgFormidableParser.js.map